    ...
    return (
        <div className='w-full h-full'>
            <div className='md:w-3/5 mx-auto px-5'>
                <h2 className='text-5xl font-semibold text-gray-800 font-mono my-4 text-center mb-3'>About us</h2>
                ...
                <div className="my-4 md:max-w-[700px]">
                    ...
                    <p className='text-gray-500 font-semibold'><span className='text-black'>Mission:</span> To empower individuals to share their stories and ideas effortlessly and to foster a community where knowledge and creativity can flourish.</p>
                    <p className='text-gray-500 font-semibold'><span className='text-black'>Vision:</span> To become the leading global blogging platform that revolutionizes how people create, consume, and connect through written content.</p>
                </div>
